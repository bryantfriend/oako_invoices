...
import { renderCollections } from "./views/collectionsView.js";
...
async function initApp() {
    try {
        ...
        router.addRoute(ROUTES.COLLECTIONS, renderCollections);
        router.addRoute(ROUTES.PRODUCTION_PLANNER, renderProductionPlanner);
        router.addRoute(ROUTES.DELIVERY, renderDeliveryWorkspace);
