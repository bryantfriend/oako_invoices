...
function createArchiveCustomerIntent(actor, payload) {
    return {
        type: "ArchiveCustomerIntent", actor: actor, payload: payload, context: {},
        stages: {
...
export default { createArchiveCustomerIntent: createArchiveCustomerIntent };
